...
public class CuentaPrueba {
	public static void main(String[] args) {
		...
		System.out.println("Número de cuenta: " + cuenta1.getCc());
		...
		System.out.println("Número de cuenta: " + cuenta2.getCc());
		...
		System.out.println("Número de cuenta: " + cuenta3.getCc());
